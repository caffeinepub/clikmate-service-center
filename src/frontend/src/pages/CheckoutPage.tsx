              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  <Input
                    ...
                    value={phone}
                    readOnly
                    className="rounded-xl border-gray-200 h-11 bg-gray-50 text-gray-500"
                  />
                </div>
              </div>
            </section>
              ...
              {paymentMethod === "upi" && (
                <div className="mt-5 p-5 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 flex flex-col sm:flex-row items-center gap-6">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <div className="text-xs text-gray-500 bg-white/80 border border-blue-100 rounded-xl px-3 py-2">
              ...
              <div className="flex flex-col gap-3 mb-4">
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="font-semibold text-blue-900 ml-3">
